...
if(isset($_POST['insert_product'])){
    ...
    if( $product_title == '' or $description=='' or  $product_keywords=='' or $product_category=='' or $brand_category=='' or  $product_price==''
    or  $product_image1=='' or  $product_image2=='' or  $product_image3==''  ){
        ...
        '$product_keywords',' $product_category','$brand_category',' $product_image1','$product_image2',' $product_image3',
...
<body class="bg-light">
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <!--Brands-->
            <div class="form-outline mb-4 w-50 m-auto">
                <select name="brand_category" id="" class="form-select">
